...
которым приписан комментарий, в консоль.
  ...
  метод forEach.
    ...
    4. 1.Необходимо вывести в консоль массив продуктов в котором есть хоть одна 
    ...
    const products = [
      ...
      const resultFilter = products.filter(element => element.photos?.length > 0);
    console.log(resultFilter);
    function arraySortPrice(a, b) {
        if (a.price > b.price) {
          return 1;
        }
        if (a.price < b.price) {
